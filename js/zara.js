$(document).ready(function(){
	...
	$("body").on("mousemove",function(e){
		...
		$(".obj13").css({"left":-100+posX , "bottom":-95+posY });
		
		$(".obj21").css({"right":-710-posX , "bottom":-420-posY });
		$(".obj22").css({"right":-50+posX , "bottom":-162+posY });
		...
		$(".obj43").css({"right":-100+posX , "bottom":-200+posY });
		
		$(".obj51").css({"left":-100-posX , "bottom":-120-posY });
